...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<br> <label for="sel1"> 거래일 </label><br> <input type="date"
				name="from" />
				<br /> <br> <label for="sel1"> 거래처번호 </label>
			<div class="col-sm-20">
				<input type="text" class="form-control" id="inputcode"
			...
			<br /> <br> <label for="sel1"> 차변계정 </label>
			<div class="col-sm-20">
				<input type="text" class="form-control" id="inputcode"
					placeholder="debtorNo">
			</div>
			<br /> <br> <label for="sel1"> 차변금액 </label>
			<div class="col-sm-20">
				<input type="text" class="form-control" id="inputcode"
					placeholder="debtorAmmount">
			</div>
			<br /> <br> <label for="sel1"> 대변계정 </label>
			<div class="col-sm-20">
				<input type="text" class="form-control" id="inputcode"
					placeholder="creditNo">
			</div>
			<br /> <br> <label for="sel1"> 대변금액 </label>
			<div class="col-sm-20">
				<input type="text" class="form-control" id="inputcode"
					placeholder="creditAmmount">
			</div>
			<br /> <br> <label for="sel1"> 사용조회 가능여부 </label>
			<div class="col-sm-20">
				<input type="text" class="form-control" id="inputcode"
					placeholder="useable">
			</div>
